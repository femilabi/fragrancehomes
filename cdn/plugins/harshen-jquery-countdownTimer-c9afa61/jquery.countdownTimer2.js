...
(function ($) {
    ...
    function onlyHours($this, opts) {
        ...
        if (window['minutes_H' + id] == opts.minutes && window['seconds_H' + id] == opts.seconds && window['hours_H' + id] == opts.hours) {
            ...
            html($this, window['hours_H' + id] + opts.timeSeparator + "00" + opts.timeSeparator + "00",opts);
            ...
            html($this, window['hours_H' + id] + opts.timeSeparator + window['minutes_H' + id] + opts.timeSeparator + window['seconds_H' + id],opts);
    ...
    function onlyMinutes($this, opts) {
        ...
        if (window['minutes_M' + id] == opts.minutes && window['seconds_M' + id] == opts.seconds) {
            ...
            html($this, window['minutes_M' + id] + opts.timeSeparator + "00",opts);
            ...
            html($this, window['minutes_M' + id] + opts.timeSeparator + window['seconds_M' + id],opts);
    ...
    function onlySeconds($this, opts) {
        ...
        html($this, window['seconds_S' + id] + " " + "sec",opts);
    ...
    function hoursMinutes($this, opts) {
        ...
        if (window['minutes_HM' + id] == opts.minutes && window['hours_HM' + id] == opts.hours) {
            ...
            html($this, window['hours_HM' + id] + opts.timeSeparator + window['minutes_HM' + id] + opts.timeSeparator + "00",opts);
            ...
            html($this, window['hours_HM' + id] + opts.timeSeparator + window['minutes_HM' + id] + opts.timeSeparator + window['seconds_HM' + id],opts);
    ...
    function minutesSeconds($this, opts) {
        ...
        if (window['minutes_MS' + id] == opts.minutes && window['seconds_MS' + id] == opts.seconds) {
            ...
            html($this, window['minutes_MS' + id] + opts.timeSeparator + window['seconds_MS' + id],opts);
    ...
    function hoursSeconds($this, opts) {
        ...
        if (window['seconds_HS' + id] == opts.seconds && window['hours_HS' + id] == opts.hours) {
            ...
            html($this, window['hours_HS' + id] + opts.timeSeparator + "00" + opts.timeSeparator + window['seconds_HS' + id],opts);
            ...
            html($this, window['hours_HS' + id] + opts.timeSeparator + window['minutes_HS' + id] + opts.timeSeparator + window['seconds_HS' + id],opts);
            window['seconds_HS' + id] -= opts.tickInterval;
    ...
    function hoursMinutesSeconds($this, opts) {
        ...
        if (window['minutes_HMS' + id] == opts.minutes && window['seconds_HMS' + id] == opts.seconds && window['hours_HMS' + id] == opts.hours) {
            ...
            html($this, window['hours_HMS' + id] + opts.timeSeparator + window['minutes_HMS' + id] + opts.timeSeparator + window['seconds_HMS' + id],opts);
    ...
    function givenDate($this, opts, type) {
        ...
        if ((endDate - startDate) > 0) {
            ...
            html($this, days + opts.timeSeparator + hours + opts.timeSeparator + minutes + opts.timeSeparator + seconds,opts);
            ...
            html($this, "00" + opts.timeSeparator + "00" + opts.timeSeparator + "00" + opts.timeSeparator + "00",opts);
            if (type == "withnoStart") {
    ...
    function currentDate($this, opts) {
        if (window['currentTime' + $this.attr('id')] == true) {
            ...
            html($this, hours + opts.timeSeparator + minutes + opts.timeSeparator + seconds,opts);
        } else {
    ...
    function secondsTimer($this) {
        ...
        html($this, window['countSeconds' + id] + " " + "sec",opts);
    ...
    function html($this, content,opts) {
        ...
        if (opts.onTick != null) {
            if ($.isFunction(opts.onTick) == true) {
				var data = {interval: opts.tickInterval,
				...
				var arr = content.split(opts.timeSeparator);
				data.seconds = arr.length > 0? parseInt(arr[arr.length - 1]) : 0;
				data.minutes = arr.length > 1? parseInt(arr[arr.length - 2]) : 0;
				data.hours = arr.length > 2? parseInt(arr[arr.length - 3]) : 0;
				data.days = arr.length > 3? parseInt(arr[arr.length - 4]) : 0;
                opts.onTick.apply($this,[data]);
            }
        }
