...
$DB->multi_query("CREATE TABLE `fh_post_categories` (
  `id` int(1) NOT NULL,
  `title` varchar(100) NOT NULL,
...
ALTER TABLE `fh_state_locations` ADD PRIMARY KEY (`id`);

ALTER TABLE `fh_state_locations` MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=341;
