...
$XMLfilename = $APP->get('rss2html_feed_url'); //'http://ictgiants.com/feed/'; //My own maxmum items line 759
...
$TEMPLATEfilename = $APP->get('rss2html_template'); //INCLUDE_PATH.'rss2html/sample-template.html';
...
if (!isset($_REQUEST['buildURL'])) {
  ...
  //
  $FeedMaxItems = $APP->get('rss2html_max_items')? $APP->get('rss2html_max_items') : 3;//My own maxmum items, since i dont use get or post
