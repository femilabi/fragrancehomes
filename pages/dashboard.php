    ...
    <div class="dashborad-box">
        ...
        <div class="section-body">
            <div class="messages">
                <div class="message">
                    <div class="thumb">
                        <img class="img-fluid" src="<?= $APP->getTemplateDir() ?>assets/img/dashboard/thumb-1.jpg" alt="">
                    </div>
                    <div class="body">
                        <h6>David Givens <span class="badge">Unread</span></h6>
                        <p class="post-time">3 Minutes ago</p>
                        <p class="content">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed
                ...
                <div class="message">
                    <div class="thumb">
                        <img class="img-fluid" src="<?= $APP->getTemplateDir() ?>assets/img/dashboard/thumb-2.jpg" alt="">
                    </div>
                    <div class="body">
